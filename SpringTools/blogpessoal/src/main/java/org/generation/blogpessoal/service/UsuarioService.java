...
@Service
public class UsuarioService {//regra de negócio senha de cadastro do usuário é encriptada, não sendo revelado no banco de dados// devolva exatamente o token com prefixo basic assim que usuario logar na aplicação  
